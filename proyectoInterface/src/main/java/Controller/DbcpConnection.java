...
public class DbcpConnection extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            out.println("<h3>Servlet json at " + request.getContextPath() + "</h3>");
            
            out.println("<h4>Conectando ... </h4>");
            DbcpImpl oConexion = new DbcpImpl();
            Connection oConnection = oConexion.newConnection();
